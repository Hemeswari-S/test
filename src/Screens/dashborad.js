...
const AdminDashboard = () => {
    ...
    return (
        ...
        <div className="d-flex" style={{ minHeight: '100vh', backgroundColor: '#f8f9fa',transition: 'All 0.5s ease' }}>
            ...
            {sidebarOpen && (
                 <div
                 className={`bg-white border-end ${sidebarOpen ? 'w-250' : ' overflow-hidden'}`}
                 style={{
             ...
             >
                    <div className="d-flex justify-content-between align-items-center px-3 py-3 border-bottom fw-bold fs-5">
                        ...
                        <i className="bi bi-list" role="button" onClick={toggleSidebar}></i>
                    </div>
                    ...
                    <div className="container-fluid d-flex justify-content-between align-items-center">
                        ...
                        <span  >
                            ...
                            >
                                ...
                                <span className="fw-semibold">F. David</span>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-2 align-items-end">
                            ...
                            {dropdownOpen && (
                                <ul className="dropdown-menu dropdown-menu-end show position-absolute w-20 mt-200 " >
                                    <li className="px-3 py-2">
                                        <i className="bi bi-person-fill me-2"></i><strong>Username:</strong> F. David
                                    </li>
                                    <li className="px-3 py-2">
